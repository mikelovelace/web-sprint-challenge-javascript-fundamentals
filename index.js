...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
// The nested function can access the variable `internal` because the variable and its reference both live in the same lexical environment. 
...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(array){
    ...
    array.forEach((animal) => {
      newArray.push(`name: ${animal.animal_name}, scientific: ${animal.scientific_name}`)
    })
    return newArray;
  }
  ...
  */
  ...
  function lowerCaseNames(array){
    const lowerCaseAnimals = array.map((animal) => {
  ...
  */
  ...
  function lowPopulationAnimals(array){
    const lowPopAnimals = array.filter((animal) => {
  ...
  */
  ...
  function USApop(array){
    const totalPop = array.reduce((accumulator, animal) => {
...
console.log(USApop(zooAnimals))
  ...
  */
  ...
  console.log(consume(8, 9, multiply))
...
function greeting(first, last){
  ...
  console.log(greeting("Mike", "Lovelace"))
...
CuboidMaker.prototype.surfaceArea = function() {
  const x = this.length * this.width;
  const y = this.length * this.height;
  const z = this.width * this.height;
